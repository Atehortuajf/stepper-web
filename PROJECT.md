...
| F12 | 16-D Technique Conditioning Sliders | Continuous sliders for $z_{\text{tech}}$ vector: crossover, footswitch, doublestep, bracket, bracket_under, bracket_crossover, sideswitch, kickswitch, holdswitch, jack, jump_jack, split_jack, bracket_tap, complex_rhythm, stream_stamina, no_tech | M3 | R3 / Stepper |
