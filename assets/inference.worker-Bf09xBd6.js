...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=e=>[12,10,1,6][[`u32`,`f16`,`f32`,`i32`].indexOf(e)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},An=(e,t)=>new kn(e,t)}),jn,Mn,Nn,Pn,Fn,In,Ln,Rn,zn,Bn=a(()=>{"use strict";I(),z(),V(),J(),jn=(e,t)=>{if(!e||e.length!==1)throw Error(`Transpose requires 1 input.`);if(t.length!==0&&t.length!==e[0].dims.length)throw Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Mn=(e,t)=>t.length===0?[...Array(e).keys()].reverse():t,Nn=(e,t)=>R.sortBasedOnPerm(e,Mn(e.length,t)),Pn=(e,t,n,r)=>{let i=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
var best_index : i32 = 0;`,`if (${e.getByIndices(`input_indices`)} ${t.selectLastIndex>0?`>=`:`>`} value) {
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l?[{type:12,data:c},...U(a)]:[{type:12,data:c}]})}},Jr=e=>B(e),Yr=(e,t)=>{let{inputs:n,outputCount:r}=e,i=Jr({...t,outputCount:r});if(x.webgpu.validateInputContent&&Kr(n,i),t.trainingMode)throw Error(`BatchNormalization trainingMode is not supported yet.`);e.compute(qr(n,i))}}),Zr,Qr,$r,ei=a(()=>{"use strict";z(),J(),Zr=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![320,640,1280].includes(e[0].dims[2]))throw Error(`number of channels should be 320, 640 or 1280`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},Qr=e=>{let t=e[0].dims,n=e[0].dims[2],r=R.size(t)/4,i=e[0].dataType,a=K(`input`,i,t,4),o=K(`bias`,i,[n],4),s=K(`residual`,i,t,4),c=q(`output`,i,t,4);return{name:`BiasAdd`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:e=>`
  ...
  }`}},$r=e=>{Zr(e.inputs),e.compute(Qr(e.inputs))}}),ti,$,ni,ri,ii,ai,oi,si,ci,li,ui,di,fi,pi,mi,hi,gi,_i,vi,yi,bi,xi,Si,Ci,wi,Ti,Ei,Di,Oi,ki,Ai,ji,Mi,Ni,Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki=a(()=>{"use strict";I(),z(),V(),J(),ti=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),c=``;c=typeof i==`string`?`${i}(a)`:i(`a`);let l=K(`inputData`,n,[s],4),u=q(`outputData`,r,[s],4),d=[{name:`vec_size`,type:`u32`}];return o&&d.push(...o),`
  ...
  }`},$=(e,t,n,r,i,a=e.dataType,o,s)=>{let c=[{type:12,data:Math.ceil(R.size(e.dims)/4)}];return o&&c.push(...o),{name:t,shaderCache:{hint:i,inputDependencies:[`type`]},getShaderSource:t=>ti(t,R.size(e.dims),e.dataType,a,n,r,s),getRunData:t=>({outputs:[{dims:e.dims,dataType:a}],dispatchGroup:{x:Math.ceil(R.size(t[0].dims)/64/4)},programUniforms:c})}},ni=e=>{e.compute($(e.inputs[0],`Abs`,`abs`))},ri=e=>{e.compute($(e.inputs[0],`Acos`,`acos`))},ii=e=>{e.compute($(e.inputs[0],`Acosh`,`acosh`))},ai=e=>{e.compute($(e.inputs[0],`Asin`,`asin`))},oi=e=>{e.compute($(e.inputs[0],`Asinh`,`asinh`))},si=e=>{e.compute($(e.inputs[0],`Atan`,`atan`))},ci=e=>{e.compute($(e.inputs[0],`Atanh`,`atanh`))},li=e=>B(e),ui=(e,t)=>{let n;switch(t.to){case 10:n=`vec4<f16>`;break;case 1:n=`vec4<f32>`;break;case 12:n=`vec4<u32>`;break;case 6:n=`vec4<i32>`;break;case 9:n=`vec4<bool>`;break;default:throw RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($(e.inputs[0],`Cast`,n,void 0,t.cacheKey,t.to))},di=e=>{let t,n,r=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=i?e[2].getUint16Array()[0]:31743;break;default:throw Error(`Unsupport data type`)}return B({min:t,max:n})},fi=(e,t)=>{let n=t||di(e.inputs),r=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`Clip`,e=>`clamp(${e}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:`min`,type:r},{name:`max`,type:r}]),{inputs:[0]})},pi=e=>{e.compute($(e.inputs[0],`Ceil`,`ceil`))},mi=e=>{e.compute($(e.inputs[0],`Cos`,`cos`))},hi=e=>{e.compute($(e.inputs[0],`Cosh`,`cosh`))},gi=e=>B(e),_i=(e,t)=>{let n=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`Elu`,e=>`elu_vf32(${e})`,`
...
}`,yi=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`Erf`,e=>`erf_vf32(${e})`,vi(t)))},bi=e=>{e.compute($(e.inputs[0],`Exp`,`exp`))},xi=e=>{e.compute($(e.inputs[0],`Floor`,`floor`))},Si=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`Gelu`,e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,vi(t)))},Ci=(e,t)=>{let n=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`LeakyRelu`,e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},wi=e=>{e.compute($(e.inputs[0],`Not`,e=>`!${e}`))},Ti=e=>{e.compute($(e.inputs[0],`Neg`,e=>`-${e}`))},Ei=e=>{e.compute($(e.inputs[0],`Reciprocal`,e=>`1.0/${e}`))},Di=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`Relu`,e=>`select(vec4<${t}>(0.0), ${e}, ${e} > vec4<${t}>(0.0))`))},Oi=e=>{e.compute($(e.inputs[0],`Sigmoid`,e=>`(1.0 / (1.0 + exp(-${e})))`))},ki=e=>B(e),Ai=(e,t)=>{let n=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`HardSigmoid`,e=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${e} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},ji=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`HardSwish`,e=>`${e} * max(vec4<${t}>(0.0), min(vec4<${t}>(1.0), vec4<${t}>(${t}(1.0 / 6.0)) * ${e} + vec4<${t}>(0.5)))`))},Mi=e=>{e.compute($(e.inputs[0],`Sin`,`sin`))},Ni=e=>{e.compute($(e.inputs[0],`Sinh`,`sinh`))},Pi=e=>{e.compute($(e.inputs[0],`Sqrt`,`sqrt`))},Fi=e=>{e.compute($(e.inputs[0],`Tan`,`tan`))},Ii=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Li=e=>{e.compute($(e.inputs[0],`Tanh`,Ii))},Ri=(e=`f32`)=>`
...
`,zi=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Bi=e=>{let t=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`FastGelu`,zi,Ri(t),void 0,e.inputs[0].dataType))},Vi=(e,t)=>{let n=Sn(e.inputs[0].dataType);return e.compute($(e.inputs[0],`ThresholdedRelu`,e=>`select(vec4<${n}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Hi=e=>{e.compute($(e.inputs[0],`Log`,`log`))},Ui=(e,t)=>`
...
`,Wi=e=>`quick_gelu_impl(${e})`,Gi=(e,t)=>{let n=Sn(e.inputs[0].dataType);e.compute($(e.inputs[0],`QuickGelu`,Wi,Ui(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),qi,Ji,Yi,Xi=a(()=>{"use strict";z(),J(),Ki(),qi=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![2560,5120,10240].includes(e[0].dims[2]))throw Error(`hidden state should be 2560, 5120 or 10240`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},Ji=e=>{let t=e[0].dims.slice();t[2]/=2;let n=K(`input`,e[0].dataType,e[0].dims,4),r=K(`bias`,e[0].dataType,[e[0].dims[2]],4),i=q(`output`,e[0].dataType,t,4),a=R.size(t)/4,o=H(e[0].dataType);return{name:`BiasSplitGelu`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${i.setByOffset(`global_idx`,`valueLeft * geluRight`)}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${_}
      }`},Qi=(e,t,n,r,i,a,o=n.dataType)=>{let s=n.dims.map(Number),c=r.dims.map(Number),l=!R.areEqual(s,c),u=s,d=R.size(s),f=!1,p=!1,m=[l];if(l){let e=Rt.calcShape(s,c,!1);if(!e)throw Error(`Can't perform binary op on the given tensors`);u=e.slice(),d=R.size(u);let t=R.size(s)===1,n=R.size(c)===1,r=s.length>0&&s[s.length-1]%4==0,i=c.length>0&&c[c.length-1]%4==0;m.push(t),m.push(n),m.push(r),m.push(i);let a=1;for(let e=1;e<u.length;e++){let t=s[s.length-e];if(t===c[c.length-e])a*=t;else break}a%4==0?(p=!0,f=!0):(t||n||r||i)&&(f=!0)}else f=!0;return m.push(f),{name:e,shaderCache:{hint:t+m.map(e=>e.toString()).join(`_`),inputDependencies:[`rank`,`rank`]},getShaderSource:e=>Zi(e,s,c,u,f,l,p,i,n.dataType,r.dataType,o,a),getRunData:()=>({outputs:[{dims:u,dataType:o}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(R.size(u)/4)},...U(s,c,u)]})}},$i=(e,t,n,r,i,a)=>{e.compute(Qi(t,i??``,e.inputs[0],e.inputs[1],n,r,a))},ea=e=>{$i(e,`Add`,(e,t)=>`${e}+${t}`)},ta=e=>{$i(e,`Div`,(e,t)=>`${e}/${t}`)},na=e=>{$i(e,`Equal`,{scalar:(e,t)=>`u32(${e}==${t})`,vector:(e,t)=>`vec4<u32>(${e}==${t})`},void 0,void 0,9)},ra=e=>{$i(e,`Mul`,(e,t)=>`${e}*${t}`)},ia=e=>{let t=K(`input`,e.inputs[0].dataType,e.inputs[0].dims).type.value;$i(e,`Pow`,{scalar:(e,t)=>`pow_custom(${e},${t})`,vector:(e,t)=>`pow_vector_custom(${e},${t})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},aa=e=>{$i(e,`Sub`,(e,t)=>`${e}-${t}`)},oa=e=>{$i(e,`Greater`,{scalar:(e,t)=>`u32(${e}>${t})`,vector:(e,t)=>`vec4<u32>(${e}>${t})`},void 0,void 0,9)},sa=e=>{$i(e,`Less`,{scalar:(e,t)=>`u32(${e}<${t})`,vector:(e,t)=>`vec4<u32>(${e}<${t})`},void 0,void 0,9)},ca=e=>{$i(e,`GreaterOrEqual`,{scalar:(e,t)=>`u32(${e}>=${t})`,vector:(e,t)=>`vec4<u32>(${e}>=${t})`},void 0,void 0,9)},la=e=>{$i(e,`LessOrEqual`,{scalar:(e,t)=>`u32(${e}<=${t})`,vector:(e,t)=>`vec4<u32>(${e}<=${t})`},void 0,void 0,9)}}),da,fa,pa,ma,ha,ga,_a=a(()=>{"use strict";I(),z(),V(),J(),da=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);let n=e[0],r=n.dataType,i=n.dims.length;e.forEach((e,a)=>{if(a!==0){if(e.dataType!==r)throw Error(`input tensors should be one type`);if(e.dims.length!==i)throw Error(`input tensors should have the same shape`);e.dims.forEach((e,r)=>{if(r!==t&&e!==n.dims[r])throw Error(`non concat dimensions must match`)})}})},fa=(e,t)=>`
...
`)},ma=(e,t,n,r)=>{let i=R.size(n),a=Array(e.length),o=Array(e.length),s=0,c=[],l=[],u=[{type:12,data:i}];for(let n=0;n<e.length;++n)s+=e[n].dims[t],a[n]=s,l.push(e[n].dims.length),o[n]=K(`input${n}`,r,l[n]),c.push(`rank`),u.push({type:12,data:a[n]});for(let t=0;t<e.length;++t)u.push(...U(e[t].dims));u.push(...U(n));let d=q(`output`,r,n.length),f=d.indicesGet(`indices`,t),p=Array.from(Array(a.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(`,`);return{name:`Concat`,shaderCache:{hint:`${t}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${pa(o,d)}
  }`}},ha=(e,t)=>{let n=e.inputs,r=n[0].dims,i=R.normalizeAxis(t.axis,r.length);da(n,i);let a=r.slice();a[i]=n.reduce((e,t)=>e+(t.dims.length>i?t.dims[i]:0),0);let o=n.filter(e=>R.size(e.dims)>0);e.compute(ma(o,i,a,n[0].dataType),{inputs:o})},ga=e=>B({axis:e.axis})}),va,ya,ba,xa,Sa=a(()=>{"use strict";I(),z(),va=(e,t,n=`f32`)=>{switch(e.activation){case`Relu`:return`value = max(value, ${t}(0.0));`;case`Sigmoid`:return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case`Clip`:return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case`HardSigmoid`:return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case`LeakyRelu`:return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case`Tanh`:return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case``:return``;default:throw Error(`Unsupported activation ${e.activation}`)}},ya=(e,t)=>{e.activation===`Clip`?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation===`HardSigmoid`?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation===`LeakyRelu`&&t.push({type:1,data:e.alpha})},ba=(e,t)=>{e.activation===`Clip`?t.push({name:`clip_max`,type:`f32`},{name:`clip_min`,type:`f32`}):e.activation===`HardSigmoid`?t.push({name:`alpha`,type:`f32`},{name:`beta`,type:`f32`}):e.activation===`LeakyRelu`&&t.push({name:`alpha`,type:`f32`})},xa=e=>{let t=e?.activation||``;if(t===`HardSigmoid`){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}if(t===`Clip`){let[n,r]=e?.activation_params||[Vt,Ht];return{activation:t,clipMax:r,clipMin:n}}if(t===`LeakyRelu`){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}}),Ca,wa,Ta=a(()=>{"use strict";Ca=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw Error(`${e}-component is not supported.`)}},wa=e=>`
...
`}),Oa,ka,Aa=a(()=>{"use strict";I(),z(),J(),Sa(),Oa=(e,t,n,r,i)=>{let a=r-n;return`
...
`},ka=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o[o.length-2],l=s[s.length-1],u=o[o.length-1],d=W(l),f=W(u),p=W(c),m=R.size(n)/d/p,h=e.length>2,g=r?r.slice(0,-2):n.slice(0,-2),_=[R.size(g),c,l],v=[{type:12,data:m},{type:12,data:c},{type:12,data:l},{type:12,data:u}];return ya(t,v),v.push(...U(g,o,s)),h&&v.push(...U(e[2].dims)),v.push(...U(_)),{name:`MatMulNaive`,shaderCache:{hint:`${t.activation};${d};${f};${p};${i}`,inputDependencies:h?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:v}),getShaderSource:r=>{let a=On(`batch_dims`,e[0].dataType,g.length),c=K(`a`,e[0].dataType,o.length,f),l=K(`b`,e[1].dataType,s.length,d),u=q(`output`,e[0].dataType,_.length,d),m=H(u.type.tensor),v=va(t,u.type.value,m),y=[c,l],b=``;if(h){let t=i?d:1;y.push(K(`bias`,e[2].dataType,e[2].dims.length,t)),b=`${i?`value += bias[col / ${t}];`:`value += ${u.type.value}(bias[row + i]);`}`}let x=[{name:`output_size`,type:`u32`},{name:`M`,type:`u32`},{name:`N`,type:`u32`},{name:`K`,type:`u32`}];ba(t,x);let S=()=>{let e=`var a_data: ${c.type.value};`;for(let t=0;t<f;t++)e+=`
...
`}return e};return`
  ...
  `}}}}),ja,Ma,Na,Pa,Fa,Ia,La,Ra,za=a(()=>{"use strict";I(),z(),J(),Sa(),Aa(),Ta(),ja=(e,t)=>e?`
...
`},La=(e,t,n,r,i=!1)=>{let[a,o,s,c]=r,l=H(r[0].type.tensor);return`
    ...
    `},Ra=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o.slice(0,-2),l=s.slice(0,-2),u=r?r.slice(0,-2):n.slice(0,-2),d=R.size(u),f=o[o.length-2],p=o[o.length-1],m=s[s.length-1],h=p%4==0&&m%4==0,g=f<=8?[4,1,1]:[4,4,1],_=[8,8,1],v=[Math.ceil(m/_[0]/g[0]),Math.ceil(f/_[1]/g[1]),Math.ceil(d/_[2]/g[2])],y=h?4:1,b=[...c,f,p/y],x=b.length,S=[...l,p,m/y],C=S.length,w=[d,f,m/y],T=[{type:6,data:f},{type:6,data:m},{type:6,data:p}];ya(t,T),T.push(...U(u,b,S));let E=[`rank`,`rank`],D=e.length>2;return D&&(T.push(...U(e[2].dims)),E.push(`rank`)),T.push(...U(w)),{name:`MatMul`,shaderCache:{hint:`${g};${t.activation};${h};${i}`,inputDependencies:E},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:T}),getShaderSource:n=>{let r=u.length,a=On(`batchDims`,e[0].dataType,r,1),o=H(e[0].dataType),s=K(`a`,e[0].dataType,x,y),c=K(`b`,e[1].dataType,C,y),l=q(`result`,e[0].dataType,w.length,y),d=[s,c];if(D){let t=i?y:1;d.push(K(`bias`,e[2].dataType,e[2].dims.length,t))}let f=[{name:`dim_a_outer`,type:`i32`},{name:`dim_b_outer`,type:`i32`},{name:`dim_inner`,type:`i32`}];ba(t,f);let p=H(l.type.tensor),m=va(t,l.type.value,p),v=La(y,D,m,[a,s,c,l],i);return`
  ${n.registerUniforms(f).registerInternalVariables(a).declareVariables(...d,l)}
  ${v}
  ${h?Na(g,_,o,a):Ia(g,_,o,a)}
                   `}}}}),Ba,Va,Ha=a(()=>{"use strict";I(),It(),J(),Sa(),Ta(),Da(),za(),Ba=(e,t,n,r,i=!1,a,o=4,s=4,c=4,l=`f32`)=>{let u=e=>{switch(e){case 1:return`resData = x[xIndex];`;case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return`resData = x[xIndex / 4];`;default:throw Error(`innerElementSize ${e} is not supported.`)}},d=e=>{switch(e){case 1:return`return w[row * i32(uniforms.w_shape[3]) + colIn];`;case 4:return`return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];`;default:throw Error(`innerElementSize ${e} is not supported.`)}},f=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${x}) {
    ...
    }`},Va=(e,t,n,r,i,a,o,s,c)=>{let l=t.format===`NHWC`,u=l?e[0].dims[3]:e[0].dims[1],d=n[0],f=l?n[2]:n[3],p=l?n[1]:n[2],m=l?n[3]:n[1],h=l&&(u%4==0||u%3==0)&&m%4==0,g=l?m:f*p,_=l?f*p:m,v=[8,8,1],y=r<=8?[4,1,1]:[4,4,1],b=[Math.ceil(g/v[0]/y[0]),Math.ceil(_/v[1]/y[1]),Math.ceil(d/v[2]/y[2])];L(`verbose`,()=>`[conv2d_mm_webgpu] dispatch = ${b}`);let x=h?l&&u%4!=0?3:4:1,S=v[1]*y[1],C=v[0]*y[0],w=Math.max(v[0]*x,v[1]),T=r%S===0,E=i%C===0,D=a%w===0,O=h?[x,4,4]:[1,1,1],ee=[{type:6,data:r},{type:6,data:i},{type:6,data:a},{type:6,data:[t.pads[0],t.pads[1]]},{type:6,data:t.strides},{type:6,data:t.dilations}];ya(t,ee),ee.push(...U(e[0].dims,e[1].dims));let k=[`rank`,`rank`];return o&&(ee.push(...U(e[2].dims)),k.push(`rank`)),ee.push(...U(n)),{name:`Conv2DMatMul`,shaderCache:{hint:`${t.cacheKey};${x};${h};${T};${E};${D};${S};${C};${w}`,inputDependencies:k},getRunData:()=>({outputs:[{dims:c?c(n):n,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:ee}),getShaderSource:r=>{let i=[{name:`dim_a_outer`,type:`i32`},{name:`dim_b_outer`,type:`i32`},{name:`dim_inner`,type:`i32`},{name:`pad`,type:`i32`,length:2},{name:`stride`,type:`i32`,length:2},{name:`dilation`,type:`i32`,length:2}];ba(t,i);let a=h?4:1,c=H(e[0].dataType),u=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${c}>`:c}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${c} {
          ...
          }`}}}}),Qa,$a,eo=a(()=>{"use strict";I(),z(),J(),Sa(),Qa=(e,t,n,r)=>{let i=e.length>2,a=i?`value += b[output_channel];`:``,o=e[0].dims,s=e[1].dims,c=t.format===`NHWC`,l=c?n[3]:n[1],u=l/t.group,d=c&&u>=4?W(l):1,f=R.size(n)/d,p=[{type:12,data:f},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:u}];ya(t,p),p.push(...U(o,[s[0],s[1],s[2],s[3]/d]));let m=i?[`rank`,`rank`,`rank`]:[`rank`,`rank`];return p.push(...U([n[0],n[1],n[2],n[3]/d])),{name:`GroupedConv`,shaderCache:{hint:`${t.cacheKey}_${d}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:p}),getShaderSource:r=>{let l=q(`output`,e[0].dataType,n.length,d),u=H(l.type.tensor),f=va(t,l.type.value,u),p=K(`x`,e[0].dataType,o.length),m=K(`w`,e[1].dataType,s.length,d),h=[p,m];i&&h.push(K(`b`,e[2].dataType,e[2].dims,d));let g=[{name:`output_size`,type:`u32`},{name:`dilations`,type:`u32`,length:t.dilations.length},{name:`strides`,type:`u32`,length:2},{name:`pads`,type:`u32`,length:2},{name:`output_channels_per_group`,type:`u32`}];ba(t,g);let _=c?`
  ...
  ${n.mainStart()}
    ...
    ${x}}`}}}}),mo,ho,go,_o,vo,yo,bo,xo,So,Co=a(()=>{"use strict";po(),Sa(),Bn(),mo=(e,t,n,r,i,a)=>(e-1)*t+n+(r-1)*i+1-a,ho=(e,t,n,r,i)=>{let a=Math.floor(e/2);t===`SAME_UPPER`?(n[r]=a,n[i]=e-a):t===`SAME_LOWER`&&(n[r]=e-a,n[i]=a)},go=(e,t,n,r,i,a,o,s,c,l)=>{let u=e.length-2,d=l.length===0;c.length<u&&c.push(...Array(u-c.length).fill(0));let f=e[0],p=t[s?3:1]*i;for(let i=0,f=e.length-u-+!!s;i<u;++i,++f){let s=e[f],p=d?s*o[i]:l[i],m=mo(s,o[i],a[i],t[f],n[i],p);ho(m,r,a,i,i+u),d&&l.push(o[i]*(s-1)+c[i]+(t[f]-1)*n[i]+1-a[i]-a[i+u])}l.splice(0,0,f),l.splice(s?3:1,0,p)},_o=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((e,t)=>e*t,1)===0){n.length=0;for(let e=2;e<t[1].dims.length;++e)n.push(t[1].dims[e])}let r=e.format===`NHWC`;n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let i=e.pads.slice(),a=e.outputShape.slice(),o=e.outputPadding.slice(),s=t[0].dims,c=e.dilations.slice();if(c.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;c=Array(e).fill(1)}let l=e.strides.slice();if(l.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;l=Array(e).fill(1)}go(s,n,c,e.autoPad,e.group,i,l,r,o,a);let u=Object.assign({},e);return Object.assign(u,{kernelShape:n,pads:i,outputPadding:o,outputShape:a,dilations:c,strides:l}),u},vo=e=>{let t=xa(e),n=e.format,r=[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][typeof e.autoPad>`u`?0:e.autoPad],i=e.dilations,a=e.group??1,o=e.kernelShape,s=e.pads,c=e.strides,l=e.wIsConst();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:s,strides:c,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},yo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw Error(`Conv requires 2 or 3 inputs`);if(e[0].dims.length!==4&&e[0].dims.length!==3)throw Error(`currently only support 2-dimensional conv`);if(e[0].dims.length!==e[1].dims.length)throw Error(`filter does not have same dimension as input`);if(e[0].dims[t.format===`NHWC`?e[0].dims.length-1:1]!==e[1].dims[0])throw Error(`FILTER_IN_CHANNEL should be equal to DATA_CHANNEL`);let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw Error(`invalid bias`);let r=e[0].dims.length-2;if(t.dilations.reduce((e,t)=>e+t,0)>0&&t.dilations.length!==r)throw Error(`dilations should be ${r}D`);if(t.strides.reduce((e,t)=>e+t,0)>0&&t.strides.length!==r)throw Error(`strides should be ${r}D`);if(t.pads.reduce((e,t)=>e+t,0)>0&&t.pads.length!==r*2)throw Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((e,t)=>e+t,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw Error(`invalid kernel shape`);if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw Error(`invalid output shape`)},bo=(e,t,n,r)=>{let i=e.kernelCustomData.wT??e.compute(Ln(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let a=[t[0],i];t.length===3&&a.push(t[2]),e.compute(fo(a,n,r),{inputs:a})},xo=(e,t)=>{let n=t.format===`NHWC`,r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let s=t.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],o=[1].concat(o),a=[1].concat(a),i=[1].concat(i);let c=t.outputPadding;c=[0].concat(c);let l=_o({...t,pads:s,strides:o,dilations:a,kernelShape:i,outputPadding:c},r);bo(e,r,l,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])},So=(e,t)=>{if(yo(e.inputs,t),e.inputs[0].dims.length===3)xo(e,t);else{let n=_o(t,e.inputs);bo(e,e.inputs,n)}}}),wo,To,Eo,Do=a(()=>{"use strict";I(),z(),V(),J(),wo=(e,t,n,r)=>{let i=R.size(t),a=t.length,o=K(`input`,e,a),s=q(`output`,e,a),c=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=R.normalizeAxis(c,a);return{name:`CumSum`,shaderCache:{hint:r.cacheKey,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:l},...U(t,t)]}),getShaderSource:e=>{let t=` i32(${o.indicesGet(`inputIndices`,`uniforms.axis`)}) `,n=G(`uniforms.input_shape`,`uniforms.axis`,a),i=r.reverse?t+(r.exclusive?` + 1`:``):`0`,c=r.reverse?n:t+(r.exclusive?``:` + 1`);return`
                ...
                }`}}},To=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,i=e.inputs[1];e.compute(wo(r,n,i,t),{inputs:[0]})},Eo=e=>{let t=e.exclusive===1,n=e.reverse===1;return B({exclusive:t,reverse:n})}}),Oo,ko,Ao,jo,Mo,No=a(()=>{"use strict";I(),z(),V(),J(),Oo=e=>{if(!e||e.length!==1)throw Error(`DepthToSpace requires 1 input.`);if(e[0].dims.length!==4)throw Error(`DepthToSpace requires 4D input.`)},ko=(e,t,n,r)=>{let i=[];i.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)};
          ...
          }`}}},ss=(e,t)=>{let n=new is(e.inputs,t.equation),r=n.outputDims,i=e.inputs.map((e,t)=>e.dims);e.compute(os(i,e.inputs[0].dataType,n,r))},cs=e=>{let t=e.equation.replace(/\s+/g,``);return B({equation:t})}}),us,ds,fs,ps,ms,hs=a(()=>{"use strict";I(),z(),J(),us=e=>{if(!e||e.length!==2)throw Error(`Expand requires 2 input.`);let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,i=t.length<n.length?0:t.length-n.length;for(;r<n.length&&i<t.length;++r,++i)if(n[r]!==t[i]&&n[r]!==1&&t[i]!==1)throw Error(`Expand requires shape to be broadcastable to input`)},ds=(e,t)=>{let n=e.length-t.length,r=[];for(let t=0;t<n;++t)r.push(e[t]);for(let i=0;i<t.length;++i)r.push(t[i]===1?e[i+n]:t[i]);return r},fs=(e,t)=>e.length>t.length?ds(e,t):ds(t,e),ps=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=fs(t,n),i=e[0].dataType,a=i===9||R.size(t)===1,o=i===9||t.length>0&&t[t.length-1]%4==0?4:1,s=a||r.length>0&&r[r.length-1]%4==0?4:1,c=Math.ceil(R.size(r)/s),l=e=>{let n=K(`input`,i,t.length,o),a=q(`output`,i,r.length,s),c;if(i===9){let e=(e,t,r=``)=>`
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
    ${c}`},u=[{type:12,data:c},...U(t,r)];return{name:`Expand`,shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:[`rank`]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:u})}},ms=e=>{us(e.inputs),e.compute(ps(e.inputs),{inputs:[0]})}}),gs,_s,vs=a(()=>{"use strict";I(),z(),J(),Ki(),gs=e=>{let t=e[0].dataType,n=R.size(e[0].dims),r=R.size(e[1].dims),i=r%4==0;return{name:`FastGeluWithBias`,shaderCache:{hint:`${i}`,inputDependencies:[`type`,`type`]},getShaderSource:e=>{let n=K(`x`,t,[1],4),r=K(`bias`,t,[1],4),a=q(`y`,t,[1],4),o=[{name:`output_vec_size`,type:`u32`},{name:`bias_size`,type:`u32`}],s=e=>`
  ...
  }`}}},Bs=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}),Vs=(e,t)=>{Rs(e.inputs),e.compute(zs(e.inputs,t))}}),Us,Ws,Gs,Ks,qs,Js,Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc=a(()=>{"use strict";I(),z(),V(),J(),[Us,Ws,Gs,Ks]=[0,1,2,3],qs=e=>{if(e[0].dims.length!==4)throw Error(`only 4-D tensor is supported.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`input dimensions must be equal to grid dimensions`);if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error(`grid batch size must match input batch size`)},Js=`
...
`,$s=(e,t,n)=>(()=>{switch(n.mode){case`nearest`:return`
        ...
        `;default:throw Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset(`global_idx`,`result`)}`,ec=(e,t)=>{let n=K(`x`,e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=K(`grid`,e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format===`NHWC`&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[Us,Ws,Gs,Ks]=[0,3,1,2]);let o=q(`output`,e[0].dataType,a.length),s=n.type.value,c=[{type:12,data:R.size(a)},...U(e[0].dims,r,a)];return{name:`GridSample`,shaderCache:{hint:`${t.cacheKey}`,inputDependencies:[`type`,`type`]},getRunData:e=>{let t=R.size(a);return{outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)},programUniforms:c}},getShaderSource:e=>`
...
`)}
  ...
  `}}},Oc=(e,t)=>{if(e.inputs.length>14&&e.inputs[14]||e.inputs.length>15&&e.inputs[15])throw Error(`GroupQueryAttention (JSEP): q_norm_weight / k_norm_weight inputs are not supported. The per-head Q/K RMS normalization prologue is implemented only on the CUDA and native WebGPU EPs.`);let n=wc(e.inputs,t);if(e.inputs[0].dims.length===5)throw Error(`Packed QKV is not implemented`);if(e.inputs[1]?.dims.length===5)throw Error(`Packed KV is not implemented`);let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,c=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,u=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=B({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,u*n.headSize,u*n.headSize]}),[f,p,m]=!i&&!a?e.compute(gc([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],h,g;if(t.doRotary){let r=e.compute(Dc(n.batchSize,n.sequenceLength,c,l),{inputs:[c,l],outputs:[-1]})[0],i=e.inputs[7],a=e.inputs[8],o=B({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),s=[f,r,i,a],u=[-1];h=e.compute(xc(s,o),{inputs:s,outputs:u})[0],s.splice(0,1,p);let d=B({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});g=e.compute(xc(s,d),{inputs:s,outputs:u})[0]}let _=lc(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?h:f,void 0,0),v=Ec(e,t.doRotary?g:p,n),y=Ec(e,m,n);Hr(e,_,v,y,void 0,void 0,o,s,void 0,n,c,l)}}),Ac,jc,Mc,Nc,Pc=a(()=>{"use strict";I(),z(),Bn(),J(),Ac=(e,t,n,r,i,a,o,s)=>{let c=W(a),l=c===1?`f32`:`vec${c}f`,u=c===1?`vec2f`:`mat2x${c}f`,d=i*o,f=64;d===1&&(f=256);let p=[i,o,a/c],m=[i,o,2],h=[`rank`,`type`,`type`],g=[];return g.push(...U(p,m)),e.compute({name:`InstanceNormComputeChannelScaleShift`,shaderCache:{hint:`${c};${s};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:g}),getShaderSource:e=>{let i=K(`x`,t.dataType,3,c),a=[i,K(`scale`,n.dataType,n.dims),K(`bias`,r.dataType,r.dims),q(`output`,1,3,2)];return`
  ...
  }`}},{inputs:[t,n,r],outputs:[-1]})[0]},jc=(e,t,n)=>{let r=t[0].dims,i=r,a=r[0],o=r[1],s=R.sizeFromDimension(r,2),c=W(s),l=R.size(i)/c,u=Ac(e,t[0],t[1],t[2],a,s,o,n.epsilon),d=[a,o,s/c],f=[a,o];e.compute({name:`InstanceNormalization`,shaderCache:{hint:`${c}`,inputDependencies:[`type`,`none`]},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:[{type:12,data:l},...U(d,f,d)]}),getShaderSource:e=>{let n=K(`x`,t[0].dataType,d.length,c),r=K(`scale_shift`,1,f.length,2),i=q(`output`,t[0].dataType,d.length,c),a=[n,r,i];return`
  ...
  }`}},{inputs:[t[0],h]})},Nc=(e,t)=>{t.format===`NHWC`?Mc(e,e.inputs,t):jc(e,e.inputs,t)}}),Fc,Ic,Lc,Rc=a(()=>{"use strict";I(),z(),J(),Fc=e=>{if(!e||e.length<2)throw Error(`layerNorm requires at least 2 inputs.`)},Ic=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,c=R.normalizeAxis(t.axis,i.length),l=R.sizeToDimension(i,c),u=R.sizeFromDimension(i,c),d=R.size(a.dims),f=o?R.size(o.dims):0;if(d!==u||o&&f!==u)throw Error(`Size of X.shape()[axis:] == ${u}.
  ...
  ${t.mainStart()}
    ...
    ${v?`inv_std_output[global_idx] = inv_std_dev`:``};
  }`},b=[{dims:s,dataType:e[0].dataType}];return _&&b.push({dims:p,dataType:1}),v&&b.push({dims:p,dataType:1}),{name:`LayerNormalization`,shaderCache:{hint:`${m};${n};${r}`,inputDependencies:h},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:y}},Lc=(e,t)=>{Fc(e.inputs),e.compute(Ic(e.inputs,t,e.outputCount))}}),zc,Bc,Vc=a(()=>{"use strict";z(),Aa(),za(),zc=e=>{if(!e||e.length!==2)throw Error(`MatMul requires 2 inputs.`);if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw Error(`shared dimension does not match.`)},Bc=e=>{zc(e.inputs);let t=Rt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw Error(`Can't use matmul on the given tensors`);let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(ka(e.inputs,{activation:``},t));else{let i=t[t.length-2],a=R.size(e.inputs[0].dims.slice(0,-2)),o=R.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let i=e.inputs[0].reshape([1,a,r]),o=e.inputs[1].reshape([1,r,n]),s=[1,a,n],c=[i,o];e.compute(Ra(c,{activation:``},t,s),{inputs:c})}else e.compute(Ra(e.inputs,{activation:``},t))}}}),Hc,Uc,Wc,Gc,Kc,qc=a(()=>{"use strict";I(),z(),V(),J(),Hc=(e,t)=>{if(e.length<3||e.length>4)throw Error(`MatMulNBits requires 3 or 4 inputs`);let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw Error(`The last dim of input shape does not match the k value`);let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!R.areEqual(o.dims,[t.n,i,a]))throw Error(`The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize`);let s=e[2].dims;if(R.size(s)!==t.n*i)throw Error(`scales input size error.`);if(e.length===4){let n=e[3].dims,r=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(R.size(n)!==r)throw Error(`zeroPoints input size error.`)}},Uc=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),c=R.size(s),l=e[1].dims[2]/4,u=e[0].dataType,d=W(t.k),f=W(l),p=W(o),m=s.concat([i,o]),h=i>1&&o/p%2==0?2:1,g=R.size(m)/p/h,_=[],v=[c,i,a/d],y=R.convertShape(e[1].dims).slice();y.splice(-1,1,l/f),_.push(...U(v)),_.push(...U(y)),_.push(...U(e[2].dims)),e.length===4&&_.push(...U(R.convertShape(e[3].dims)));let b=[c,i,o/p];return _.push(...U(b)),{name:`MatMulNBits`,shaderCache:{hint:`${t.blockSize};${t.bits};${d};${f};${p};${h};64`,inputDependencies:Array(e.length).fill(`rank`)},getRunData:()=>({outputs:[{dims:m,dataType:u}],dispatchGroup:{x:g},programUniforms:_}),getShaderSource:n=>{let r=v.length,i=K(`a`,e[0].dataType,r,d),a=K(`b`,12,y.length,f),o=K(`scales`,e[2].dataType,e[2].dims.length),s=[i,a,o],c=e.length===4?K(`zero_points`,12,e[3].dims.length):void 0;c&&s.push(c);let u=b.length,m=q(`output`,e[0].dataType,u,p),g=H(e[0].dataType),_=(()=>{switch(d){case 1:return`array<${g}, 8>`;case 2:return`mat4x2<${g}>`;case 4:return`mat2x4<${g}>`;default:throw Error(`${d}-component is not supported.`)}})(),x=Math.floor(32/t.bits),S=Math.floor(x/8),C=()=>{let e=``;for(let n=0;n<S;n++){let r=n*t.bits*4,a=r+t.bits;e+=`
          // reuse a data (pass ${n})
        ...
        }`}}},Gc=(e,t)=>{Hc(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor(`intel`)&&e.adapterInfo.isArchitecture(`gen-12lp`)?e.compute(Wc(e.inputs,t)):e.compute(Uc(e.inputs,t))},Kc=e=>B(e)}),Jc,Yc,Xc,Zc,Qc,$c,el,tl,nl,rl=a(()=>{"use strict";I(),z(),J(),Jc=e=>{if(!e||e.length<1)throw Error(`Too few inputs`);if(e[0].dataType!==1&&e[0].dataType!==10)throw Error(`Input type must be float or float16.`);if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw Error(`The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].`)}},Yc=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
    ...
    `,``,t.dataType===10?-65504:-1e5,l,u,d,f)}},yl=(e,t)=>{il(e.inputs),e.compute(vl(`MaxPool`,e.inputs[0],!1,t))},bl=e=>{let t=e.storage_order,n=e.dilations,r=dl(e);if(t!==0)throw Error(`column major storage order is not yet supported for MaxPool`);if(r.ceilMode!==0)throw Error(`ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel`);let i={storageOrder:t,dilations:n,...r,cacheKey:``};return{...i,cacheKey:ul(i)}},xl=e=>{let t=e.format;return{format:t,...hl,cacheKey:t}},Sl=(e,t)=>{il(e.inputs),e.compute(vl(`GlobalMaxPool`,e.inputs[0],!0,t))}}),wl,Tl,El,Dl,Ol=a(()=>{"use strict";I(),z(),V(),J(),wl=(e,t)=>{if(e.length<2||e.length>3)throw Error(`DequantizeLinear requires 2 or 3 inputs.`);if(e.length===3&&e[1].dims===e[2].dims)throw Error(`x-scale and x-zero-point must have the same shape.`);if(e.length===3&&e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw Error(`scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.`);if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==e[2].dims.length)throw Error(`scale and zero-point inputs must have the same rank.`);if(!e[1].dims.map((t,n)=>t===e[2].dims[n]).reduce((e,t)=>e&&t,!0))throw Error(`scale and zero-point inputs must have the same shape.`)}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw Error(`blockSize must be set only for block quantization.`);if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((e,t)=>e&&t,!0))throw Error(`For block qunatization, scale input shape to match the input shape except for the axis`);if(e[1].dims.length!==e[0].dims.length)throw Error(`For block qunatization the scale input rank must be the same as the x rank.`);let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw Error(`blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].`)}},Tl=(e,t)=>{let n=R.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=R.size(a),c=r===3||r===2,l=c?[Math.ceil(R.size(e[0].dims)/4)]:e[0].dims,u=e[1].dims,d=e.length>2?e[2]:void 0,f=d?c?[Math.ceil(R.size(d.dims)/4)]:d.dims:void 0,p=u.length===0||u.length===1&&u[0]===1,m=p===!1&&u.length===1,h=W(s),g=p&&(!c||h===4),_=g?h:1,v=g&&!c?h:1,y=K(`input`,c?12:r,l.length,v),b=K(`scale`,o,u.length),x=d?K(`zero_point`,c?12:r,f.length):void 0,S=q(`output`,o,a.length,_),C=[y,b];x&&C.push(x);let w=[l,u];d&&w.push(f);let T=[{type:12,data:s/_},{type:12,data:n},{type:12,data:t.blockSize},...U(...w,a)];return{name:`DequantizeLinear`,shaderCache:{hint:t.cacheKey,inputDependencies:x?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/_/64),y:1,z:1},programUniforms:T})}},El=(e,t)=>{wl(e.inputs,t),e.compute(Tl(e.inputs,t))},Dl=e=>B({axis:e.axis,blockSize:e.blockSize})}),kl,Al,jl,Ml=a(()=>{"use strict";De(),I(),J(),kl=(e,t,n)=>{if(e===t||e<t&&n<0||e>t&&n>0)throw Error(`Range these inputs' contents are invalid.`)},Al=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...U(a)];return{name:`Range`,shaderCache:{hint:`${r}`},getShaderSource:e=>{let t=q(`output`,r,a.length),n=t.type.value,i=[{name:`outputSize`,type:`u32`},{name:`start`,type:n},{name:`delta`,type:n}];return`
        ${e.registerUniforms(i).declareVariables(t)}
        ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.outputSize`)}
        output[global_idx] = uniforms.start + ${n}(global_idx) * uniforms.delta;
      }`},getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},jl=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),x.webgpu.validateInputContent&&kl(t,n,r),e.compute(Al(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),Nl,Pl,Fl,Il,Ll=a(()=>{"use strict";I(),z(),V(),J(),Nl=(e,t,n,r)=>{if(e!==`none`&&r!==`i32`&&r!==`u32`&&r!==`f32`)throw Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
              ...
              ${i}bitcast<${r}>(oldValue) + (${n})${a}`;case`max`:return r===`i32`||r===`u32`?`atomicMax(&${t}, bitcast<${r}>(${n}));`:`
                ${i}max(bitcast<f32>(oldValue), (${n}))${a}`;case`min`:return r===`i32`||r===`u32`?`atomicMin(&${t}, bitcast<${r}>(${n}));`:`${i}min(bitcast<${r}>(oldValue), (${n}))${a}`;case`mul`:return`${i}(bitcast<${r}>(oldValue) * (${n}))${a}`;default:throw Error(`Reduction ${e} is not supported.`)}},Pl=(e,t)=>{let n=e[0].dims,r=e[1].dims,i=n,a=Math.ceil(R.sizeToDimension(r,r.length-1)/1),o=r[r.length-1],s=R.sizeFromDimension(n,o),c=[{type:12,data:a},{type:12,data:o},{type:12,data:s},...U(e[1].dims,e[2].dims,i)];return{name:`ScatterND`,shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:n=>{let r=K(`indices`,e[1].dataType,e[1].dims.length),a=K(`updates`,e[2].dataType,e[2].dims.length,1),o=t.reduction!==`none`&&t.reduction!==``?Dn(`output`,e[0].dataType,i.length):q(`output`,e[0].dataType,i.length,1);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Nl(t.reduction,`output[data_offset + i]`,`value`,o.type.value)}
      ...
      }`}}},Fl=e=>B({reduction:e.reduction}),Il=(e,t)=>{e.compute(Pl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,$l,eu,tu,nu,ru,iu=a(()=>{"use strict";I(),z(),V(),J(),Rl=(e,t)=>{if(e.every(e=>e>0||(()=>{throw Error(`Resize requires scales input values to be positive`)})),e.length>0){if(t.mode===`linear`){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
    ...
    }`}},Du=e=>{wu(e.inputs),e.compute(Eu(e.inputs),{inputs:[0]})}}),ku,Au,ju,Mu=a(()=>{"use strict";I(),z(),J(),ku=(e,t,n,r,i)=>{let a=q(`output_data`,i,n.length,4),o=K(`a_data`,t[1].dataType,t[1].dims.length,4),s=K(`b_data`,t[2].dataType,t[2].dims.length,4),c=K(`c_data`,t[0].dataType,t[0].dims.length,4),l,u=(e,t,n)=>`select(${t}, ${e}, ${n})`;if(!r)l=a.setByOffset(`global_idx`,u(o.getByOffset(`global_idx`),s.getByOffset(`global_idx`),c.getByOffset(`global_idx`)));else{let e=(e,t,n=``)=>{let r=`a_data[index_a${t}][component_a${t}]`,i=`b_data[index_b${t}][component_b${t}]`,l=`bool(c_data[index_c${t}] & (0xffu << (component_c${t} * 8)))`;return`
...
* =============================================================================
*/
var Ld=class{sampleRate;nFft;nMels;fMin;fMax;ticksPerBeat;compressionFactor;hannWindow;melFilterbank;bitReverseTable;twiddleReal;twiddleImag;constructor(e){this.sampleRate=e?.sampleRate??44100,this.nFft=e?.nFft??1024,this.nMels=e?.nMels??128,this.fMin=e?.fMin??0,this.fMax=e?.fMax??this.sampleRate/2,this.ticksPerBeat=e?.ticksPerBeat??48,this.compressionFactor=e?.compressionFactor??1e4,this.hannWindow=new Float32Array(this.nFft);for(let e=0;e<this.nFft;e++)this.hannWindow[e]=.5*(1-Math.cos(2*Math.PI*e/this.nFft));let t=Math.log2(this.nFft);this.bitReverseTable=new Uint16Array(this.nFft);for(let e=0;e<this.nFft;e++){let n=0;for(let r=0;r<t;r++)e>>r&1&&(n|=1<<t-1-r);this.bitReverseTable[e]=n}let n=this.nFft/2;this.twiddleReal=new Float32Array(n),this.twiddleImag=new Float32Array(n);for(let e=0;e<n;e++){let t=-2*Math.PI*e/this.nFft;this.twiddleReal[e]=Math.cos(t),this.twiddleImag[e]=Math.sin(t)}this.melFilterbank=this.createSlaneyMelFilterbank()}hzToMel(e){let t=1e3,n=27/Math.log(6.4);return e>=t?15+Math.log(e/t)*n:e/66.66666666666667}melToHz(e){let t=Math.log(6.4)/27;return e>=15?1e3*Math.exp(t*(e-15)):e*66.66666666666667}createSlaneyMelFilterbank(){let e=this.nFft/2+1,t=new Float32Array(e*this.nMels),n=this.hzToMel(this.fMin),r=this.hzToMel(this.fMax),i=new Float64Array(this.nMels+2);for(let e=0;e<this.nMels+2;e++)i[e]=n+e*(r-n)/(this.nMels+1);let a=new Float64Array(this.nMels+2);for(let e=0;e<this.nMels+2;e++)a[e]=this.melToHz(i[e]);let o=new Float64Array(e);for(let t=0;t<e;t++)o[t]=t*this.sampleRate/this.nFft;for(let n=0;n<this.nMels;n++){let r=a[n],i=a[n+1],s=a[n+2],c=2/(s-r);for(let a=0;a<e;a++){let e=o[a];if(e>=r&&e<=i){let o=i>r?(e-r)/(i-r):0;t[a*this.nMels+n]=o*c}else if(e>=i&&e<=s){let r=s>i?(s-e)/(s-i):0;t[a*this.nMels+n]=r*c}}}return t}rfftPower(e,t,n,r){let i=this.nFft;for(let r=0;r<i;r++){let i=this.bitReverseTable[r];t[i]=e[r],n[i]=0}for(let e=2;e<=i;e<<=1){let r=e>>1,a=i/e;for(let o=0;o<i;o+=e)for(let e=0;e<r;e++){let i=e*a,s=t[o+e],c=n[o+e],l=t[o+e+r],u=n[o+e+r],d=this.twiddleReal[i],f=this.twiddleImag[i],p=l*d-u*f,m=l*f+u*d;t[o+e]=s+p,n[o+e]=c+m,t[o+e+r]=s-p,n[o+e+r]=c-m}}let a=i/2+1;for(let e=0;e<a;e++){let i=t[e],a=n[e];r[e]=i*i+a*a}}extract(e,t,n=140,r=0,i=0,a=0){n<=0&&(n=120);let o=t*this.ticksPerBeat,s=this.nFft/2+1,c=this.nFft/2,l=new Float32Array(this.nFft),u=new Float32Array(this.nFft),d=new Float32Array(this.nFft),f=new Float32Array(s),p=new Float32Array(o*this.nMels),m=new Float32Array(o*this.nMels),h=e.length;for(let t=0;t<o;t++){let o=(i+t/this.ticksPerBeat)*(60/n)-r,g=Math.round((o-a)*this.sampleRate);for(let t=0;t<this.nFft;t++){let n=g-c+t,r=n>=0&&n<h?e[n]:0;l[t]=r*this.hannWindow[t]}this.rfftPower(l,u,d,f);let _=t*this.nMels;for(let e=0;e<this.nMels;e++){let n=0;for(let t=0;t<s;t++)n+=f[t]*this.melFilterbank[t*this.nMels+e];let r=Math.log1p(this.compressionFactor*n);if(p[_+e]=r,t===0)m[_+e]=0;else{let n=r-p[(t-1)*this.nMels+e];m[_+e]=n>0?n:0}}}let g=2*o*this.nMels,_=new Float32Array(g);return _.set(p,0),_.set(m,o*this.nMels),_}};new Ld;let Rd={0:`0000`,1:`1000`,2:`0100`,3:`0010`,4:`0001`,5:`1100`,6:`1010`,7:`0101`,8:`0011`,9:`1001`,10:`0110`,11:`0111`,12:`1011`,13:`1101`,14:`1110`,15:`1111`,16:`2000`,17:`0200`,18:`0020`,19:`0002`,20:`4000`,21:`0400`,22:`0040`,23:`0004`,24:`3000`,25:`0300`,26:`0030`,27:`0003`,28:`M000`,29:`0M00`,30:`00M0`,31:`000M`,32:`1200`,33:`1020`,34:`1002`,35:`2100`,36:`0120`,37:`0102`,38:`2010`,39:`0210`,40:`0012`,41:`2001`,42:`0201`,43:`0021`,44:`1300`,45:`1030`,46:`1003`,47:`3100`,48:`0130`,49:`0103`,50:`3010`,51:`0310`,52:`0013`,53:`3001`,54:`0301`,55:`0031`,56:`2200`,57:`2020`,58:`2002`,59:`0220`,60:`0202`,61:`0022`,62:`3300`,63:`3030`,64:`3003`,65:`0330`,66:`0303`,67:`0033`,68:`2300`,69:`2030`,70:`2003`,71:`3200`,72:`0230`,73:`0203`,74:`3020`,75:`0320`,76:`0023`,77:`3002`,78:`0302`,79:`0032`,80:`1400`,81:`1040`,82:`1004`,83:`4100`,84:`0140`,85:`0104`,86:`4010`,87:`0410`,88:`0014`,89:`4001`,90:`0401`,91:`0041`,92:`<PAD>`,93:`<BOS>`,94:`<EOS>`,95:`<UNK>`},zd={};for(let[e,t]of Object.entries(Rd))zd[t]=parseInt(e,10);var Bd=class{difficulty;state;isTap=[];isHoldHead=[];isRollHead=[];isRelease=[];tapCount=[];isHand=[];isQuad=[];isOppositeJump=[];isSpecial=[];constructor(e=3){this.difficulty=e,this.state={activeHolds:new Set,lastPanel:null,jackCount:0,lastBeat:0},this.precomputeVocabTables()}precomputeVocabTables(){for(let e=0;e<96;e++){if(this.isTap[e]=[!1,!1,!1,!1],this.isHoldHead[e]=[!1,!1,!1,!1],this.isRollHead[e]=[!1,!1,!1,!1],this.isRelease[e]=[!1,!1,!1,!1],e===92||e===93||e===94||e===95){this.isSpecial[e]=!0,this.tapCount[e]=0,this.isHand[e]=!1,this.isQuad[e]=!1,this.isOppositeJump[e]=!1;continue}this.isSpecial[e]=!1;let t=Rd[e]||`0000`,n=0;for(let r=0;r<4;r++){let i=t[r];i===`1`?(this.isTap[e][r]=!0,n++):i===`2`?(this.isHoldHead[e][r]=!0,n++):i===`4`?(this.isRollHead[e][r]=!0,n++):i===`3`&&(this.isRelease[e][r]=!0)}this.tapCount[e]=n,this.isHand[e]=n>=3,this.isQuad[e]=n===4;let r=[];for(let t=0;t<4;t++)(this.isTap[e][t]||this.isHoldHead[e][t]||this.isRollHead[e][t])&&r.push(t);if(r.length===2){let[t,n]=r;this.isOppositeJump[e]=t===0&&n===3||t===3&&n===0||t===1&&n===2||t===2&&n===1}else this.isOppositeJump[e]=!1}}reset(){this.state={activeHolds:new Set,lastPanel:null,jackCount:0,lastBeat:0}}computeMask(e=0,t=.25){let n=new Float32Array(96),r=-1e9;if(n[92]=r,n[93]=r,n[94]=r,n[95]=r,n[0]=r,this.difficulty<=1)for(let e=0;e<96;e++)(this.isHand[e]||this.isQuad[e])&&(n[e]=r);else if(this.difficulty===2)for(let e=0;e<96;e++)this.isQuad[e]&&(n[e]=r);let i=this.state.activeHolds,a=i.size;for(let e=0;e<96;e++){if(n[e]===r)continue;let t=!1;for(let n=0;n<4;n++)if(this.isRelease[e][n]&&!i.has(n)){t=!0;break}if(t){n[e]=r;continue}let o=!1;for(let t=0;t<4;t++)if((this.isTap[e][t]||this.isHoldHead[e][t]||this.isRollHead[e][t])&&i.has(t)){o=!0;break}if(o){n[e]=r;continue}let s=0;for(let t of i)this.isRelease[e][t]&&s++;let c=a-s,l=this.tapCount[e];if(l>Math.max(0,2-c)){n[e]=r;continue}if(c===1&&l===2&&this.isOppositeJump[e]){n[e]=r;continue}if(this.state.lastPanel!==null&&this.state.jackCount>=3&&(this.isTap[e][this.state.lastPanel]||this.isHoldHead[e][this.state.lastPanel]||this.isRollHead[e][this.state.lastPanel])&&l===1){n[e]=r;continue}}return n}updateState(e,t,n){if(e<0||e>=96||this.isSpecial[e])return;for(let t=0;t<4;t++)this.isRelease[e][t]&&this.state.activeHolds.delete(t);for(let t=0;t<4;t++)(this.isHoldHead[e][t]||this.isRollHead[e][t])&&this.state.activeHolds.add(t);let r=[];for(let t=0;t<4;t++)(this.isTap[e][t]||this.isHoldHead[e][t]||this.isRollHead[e][t])&&r.push(t);if(r.length===1){let e=r[0];e===this.state.lastPanel&&n<.35?this.state.jackCount++:(this.state.lastPanel=e,this.state.jackCount=1)}else r.length>1&&(this.state.lastPanel=null,this.state.jackCount=0);this.state.lastBeat=t}};let Vd=null,Hd=null,Ud=null,Wd=`wasm`,Gd=!1,Kd=null;async function qd(e){return Gd&&Vd&&Hd&&Ud?!0:Kd||(Kd=(async()=>{try{let t=(e||`./`).endsWith(`/`)?e||`./`:`${e||`./`}/`,n=`${t}models/stepper_placement.onnx`,r=`${t}models/stepper_decoder.onnx`;x.wasm.wasmPaths=`${t}wasm/`;let i=typeof crossOriginIsolated<`u`&&crossOriginIsolated;x.wasm.numThreads=i?Math.min(4,Math.max(1,self.navigator?.hardwareConcurrency||2)):1;let a=`wasm`;if(typeof navigator<`u`&&`gpu`in navigator)try{await navigator.gpu?.requestAdapter()&&(a=`webgpu`)}catch{a=`wasm`}Wd=a;let o={executionProviders:a===`webgpu`?[`webgpu`,`wasm`]:[`wasm`],graphOptimizationLevel:`all`};return Vd=await xe.create(n,o),Hd=await xe.create(r,o),Ud=new Ld,Gd=!0,!0}catch(e){return console.warn(`[Worker] Failed to load ONNX models in worker:`,e),!1}finally{Kd=null}})(),Kd)}function Jd(e,t){let n=e.start_beat??0,r=Math.max(4,e.num_beats??16),i=typeof e.difficulty==`number`?e.difficulty:parseInt(e.difficulty,10)||9,a=Math.max(0,Math.min(4,Math.floor((i-1)/4))),o=e.tech_vector||Array(16).fill(0),s=i>=11?.25:i>=6?.5:1,c=[`1000`,`0100`,`0010`,`0001`],l=0,u=[];for(let e=n;e<n+r;e+=s){let t=`0000`,n=o[3]>.4&&Math.random()<o[3]*.5,r=o[9]>.4&&Math.random()<o[9]*.6,i=o[1]>.4&&Math.random()<o[1]*.5;n?t=`1100`:(r||i||(l=(l+1+Math.floor(Math.random()*3))%4),t=c[l]),u.push({beat:Number(e.toFixed(4)),arrows:t,chord_idx:zd[t]||1,confidence:.95})}return{placements:u,latency_ms:performance.now()-t,difficulty_id:a,difficulty_str:[`Novice`,`Easy`,`Medium`,`Hard`,`Expert`][a],model_used:`client-rule`}}async function Yd(e,t,n,r){let i=t.start_beat??0,a=Math.max(4,t.num_beats??16),o=t.bpm??140,s=t.offset??0,c=typeof t.difficulty==`number`?t.difficulty:parseInt(t.difficulty,10)||9,l=Math.max(0,Math.min(4,Math.floor((c-1)/4))),u=t.threshold??.5,d=t.temperature??1,f=t.use_fsm??!0;self.postMessage({type:`progress`,id:e,percent:15,stage:`Extracting audio features`});let p=n&&n.length>0?n:new Float32Array(Math.floor((a*60/o+1)*44100)),m=t.start_sec??60/o*i-s,h=Ud.extract(p,a,o,s,i,m);self.postMessage({type:`progress`,id:e,percent:35,stage:`Running PlacementNet ONNX`});let g=new j(`float32`,h,[1,2,a,48,128]),_=new j(`int64`,BigInt64Array.from([BigInt(l)]),[1]),v=new Float32Array(16);if(t.tech_vector&&t.tech_vector.length>0)for(let e=0;e<Math.min(16,t.tech_vector.length);e++)v[e]=t.tech_vector[e];let y=new j(`float32`,v,[1,16]),b=await Vd.run({audio:g,difficulty:_,tech_vector:y}),x=b.probs.data,S=b.acoustic_map.data,C=a*48;self.postMessage({type:`progress`,id:e,percent:50,stage:`Peak picking & NMS`});let w=[];for(let e=0;e<C;e++){let t=x[e];if(t>u){let n=e>0?x[e-1]:0,r=e<C-1?x[e+1]:0;t>=n&&t>=r&&w.push(e)}}if(w.length===0){let t=performance.now()-r;self.postMessage({type:`complete`,id:e,response:{placements:[],latency_ms:t,difficulty_id:l,difficulty_str:[`Novice`,`Easy`,`Medium`,`Hard`,`Expert`][l],model_used:`worker-${Wd}`}});return}let T=w.length,E=[],D=new Bd(l);for(let t=0;t<T;t+=64){let n=Math.min(T,t+64)-t,r=new BigInt64Array(64),a=new Float32Array(16384),o=new Float32Array(64),s=new BigInt64Array(64),c=new BigInt64Array(64),l=t>0?w[t-1]/48:0;for(let e=0;e<n;e++){let n=w[t+e],r=n/48,i=e===0&&t===0?0:r-l;l=r,o[e]=i,s[e]=BigInt(n%48),c[e]=BigInt(Math.floor(r)%4);let u=n*256;for(let t=0;t<256;t++)a[e*256+t]=S[u+t]}for(let l=0;l<n;l++){let n=t+l,u=w[n]/48,p=o[l],m=50+Math.floor(n/T*45);self.postMessage({type:`progress`,id:e,percent:m,stage:`Choreographing step ${n+1}/${T}`});let h={step_tokens:new j(`int64`,r,[1,64]),acoustic_embeddings:new j(`float32`,a,[1,64,256]),step_delta_beats:new j(`float32`,o,[1,64]),step_beat_phases:new j(`int64`,s,[1,64]),step_measure_phases:new j(`int64`,c,[1,64]),difficulty:_,tech_vector:y},g=(await Hd.run(h)).step_logits.data,v=l*96,b=new Float32Array(96),x=f?D.computeMask(u,p):new Float32Array(96);for(let e=0;e<96;e++)b[e]=g[v+e]+x[e];let S=1;if(d<=.1){let e=-1/0;for(let t=1;t<96;t++)b[t]>e&&(e=b[t],S=t)}else{let e=-1/0;for(let t=1;t<96;t++)b[t]>e&&(e=b[t]);let t=0,n=new Float32Array(96);for(let r=1;r<96;r++)if(b[r]>-1e3){let i=Math.exp((b[r]-e)/d);n[r]=i,t+=i}if(t>0){let e=Math.random()*t;for(let t=1;t<96;t++)if(e-=n[t],e<=0){S=t;break}}}r[l]=BigInt(S),D.updateState(S,u,p);let C=Rd[S]||`1000`;E.push({beat:Number((i+u).toFixed(4)),arrows:C,chord_idx:S,confidence:.95})}}let O=performance.now()-r;self.postMessage({type:`progress`,id:e,percent:100,stage:`Generation complete`}),self.postMessage({type:`complete`,id:e,response:{placements:E,latency_ms:O,difficulty_id:l,difficulty_str:[`Novice`,`Easy`,`Medium`,`Hard`,`Expert`][l],model_used:`worker-${Wd}`}})}self.onmessage=async e=>{let t=e.data;if(t){if(t.type===`init`){let e=await qd(t.baseUrl);self.postMessage({type:`init_result`,success:e,provider:Wd})}else if(t.type===`generate`){let e=performance.now();try{if(!await qd(t.baseUrl)||!Vd||!Hd||!Ud){let n=Jd(t.req,e);self.postMessage({type:`complete`,id:t.id,response:n});return}await Yd(t.id,t.req,t.waveform,e)}catch(n){console.warn(`[Worker] Inference error, falling back to rule engine:`,n);let r=Jd(t.req,e);self.postMessage({type:`complete`,id:t.id,response:r})}}}}})();